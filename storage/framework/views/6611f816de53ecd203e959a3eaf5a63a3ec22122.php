        ...
        <div class="col">
            ...
            <form method="POST" action="<?php echo e(route('admin.posts.update', $post->slug)); ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="slug" name="slug" value="<?php echo e(old('slug', $post->slug)); ?>">
                </div>
                ...
                <fieldset>
                    ...
                    <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <input type="checkbox" name="tags[]" id="tag-<?php echo e($tag->id); ?>" value="<?php echo e($tag->id); ?>"
                            <?php if(in_array($tag->id, old('tags', $post->tags->pluck('id')->all()))): ?> checked <?php endif; ?>>
                ...
                <div class="mb-3">
                    ...
                    <textarea type="text" class="form-control" id="content" name="content"><?php echo e(old('content', $post->content)); ?></textarea>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\boolean\laravel\laravel-api\resources\views/admin/posts/edit.blade.php ENDPATH**/ ?>